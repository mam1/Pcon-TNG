...
#define _SENSOR_LOG_FILE_NAME		"/media/CGI-sensor-log/sensor.dat" 		// USB drive collecting sensor readingss
...
#define _SENSOR_MASTER_FILE_NAME    "/media/Raid/SensorMaster/master.dat"	// cumulative history of sensor readings
