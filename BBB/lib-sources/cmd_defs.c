...
{	// state 4
	...
	/* 22 */    "display",
	/* 23 */    "save schedule template",
	/* 24  load        */    "load a template into the schedule buffer or load the working schedule table with a saved schedule table",
	/* 25 set         */    "load the working schedule into the working schedule table",
	/* 26 */    "load",
	/* 27 */    "unrecognized command",
	/* 28 */    "display all valid commands",
	/* 29 */    "terminate Pcon",
	...
	/* 33 */    "display debug data",
	/* 34  disp_tlib  */	"display contents of template library",
	/* 35 */	"start editing a schedule record, schedule record hour",
	/* 36 */	"alpha numeric string enclosed in quotes",
	/* 37 */	"any unrecognized token"
},
{	// state 5
